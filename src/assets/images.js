...
export const brgyImages = [brgy1, brgy2, brgy3, brgy4, brgy5, brgy6];
export const xteriumImages = [X1, X2, X3, X4, X5, X6, X7, X8];
export const dImages = [d1];
export const d2Images = [d2];

export const allImages = {
  xpense: xpenseImages,
  brgy: brgyImages,
  xterium: xteriumImages,
  design1: dImages,
  design2: d2Images,
};
